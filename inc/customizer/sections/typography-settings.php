...
function gt_spirit_customize_register_typography_settings( $wp_customize ) {
	...
	$wp_customize->add_setting( 'gt_spirit_theme_options[title_is_bold]', array(
	...
	$wp_customize->add_control( 'gt_spirit_theme_options[title_is_bold]', array(
		'label'    => esc_html_x( 'Bold', 'Font Setting', 'gt-spirit' ),
		'section'  => 'gt_spirit_section_typography',
		'settings' => 'gt_spirit_theme_options[title_is_bold]',
		'type'     => 'checkbox',
		'priority' => 30,
	) );

	// Add Title Uppercase setting.
	$wp_customize->add_setting( 'gt_spirit_theme_options[title_is_uppercase]', array(
	...
	$wp_customize->add_control( 'gt_spirit_theme_options[title_is_uppercase]', array(
		'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'gt-spirit' ),
		'section'  => 'gt_spirit_section_typography',
		'settings' => 'gt_spirit_theme_options[title_is_uppercase]',
		'type'     => 'checkbox',
		'priority' => 40,
	) );
	...
	$wp_customize->add_setting( 'gt_spirit_theme_options[navi_is_bold]', array(
	...
	$wp_customize->add_control( 'gt_spirit_theme_options[navi_is_bold]', array(
		'label'    => esc_html_x( 'Bold', 'Font Setting', 'gt-spirit' ),
		'section'  => 'gt_spirit_section_typography',
		'settings' => 'gt_spirit_theme_options[navi_is_bold]',
		'type'     => 'checkbox',
		'priority' => 60,
	) );

	// Add Navi Uppercase setting.
	$wp_customize->add_setting( 'gt_spirit_theme_options[navi_is_uppercase]', array(
	...
	$wp_customize->add_control( 'gt_spirit_theme_options[navi_is_uppercase]', array(
		'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'gt-spirit' ),
		'section'  => 'gt_spirit_section_typography',
		'settings' => 'gt_spirit_theme_options[navi_is_uppercase]',
		'type'     => 'checkbox',
		'priority' => 70,
	) );
	...
	if ( ! class_exists( 'GermanThemes_Local_Fonts' ) ) {
		$wp_customize->add_control( new GT_Spirit_Customize_Plugin_Control(
			$wp_customize, 'gt_local_fonts_plugin', array(
				'label'       => esc_html__( 'More Fonts', 'gt-spirit' ),
				'description' => esc_html__( 'You can install the GT Local Fonts plugin to extend the typography options with additional local GDPR-compatible fonts.', 'gt-spirit' ),
				'section'     => 'gt_spirit_section_typography',
				'settings'    => array(),
				'priority'    => 80,
			)
