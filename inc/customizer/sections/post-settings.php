...
function gt_spirit_customize_register_post_settings( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'gt_spirit_theme_options[post_image_single]', array(
		'selector'         => '.single-post .site-content > .site-main',
		'render_callback'  => 'gt_spirit_customize_partial_single_post',
		'fallback_refresh' => false,
	) );
}
 ...
 */
function gt_spirit_customize_partial_single_post() {
	while ( have_posts() ) {
		the_post();
