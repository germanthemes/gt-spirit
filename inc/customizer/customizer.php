...
function gt_spirit_customize_preview_js() {
	wp_enqueue_script( 'gt-spirit-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.js', array( 'customize-preview' ), '20191130', true );
}
...
function gt_spirit_customizer_controls_js() {
	wp_enqueue_script( 'gt-spirit-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.js', array(), '20191130', true );
}
