...
function gt_spirit_customize_register_options( $wp_customize ) {
	...
	$wp_customize->get_section( 'background_image' )->title   = esc_html__( 'Background', 'gt-spirit' );
}
...
function gt_spirit_customize_preview_js() {
	wp_enqueue_script( 'gt-spirit-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.min.js', array( 'customize-preview' ), '20191212', true );
	...
	if ( class_exists( 'GermanThemes_Local_Fonts' ) ) {
		...
		wp_localize_script( 'gt-spirit-customize-preview', 'gtSpiritFontSettings', $font_settings );
	}
}
...
function gt_spirit_customizer_controls_js() {
	wp_enqueue_script( 'gt-spirit-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.min.js', array(), '20191130', true );
}
...
function gt_spirit_customizer_controls_css() {
	wp_enqueue_style( 'gt-spirit-customizer-controls', get_template_directory_uri() . '/assets/css/customizer-controls.css', array(), '20191130' );
}
